...
Scan `references/rfe-creator/artifacts/strat-tasks/*.md` for strategy files. For each file, read its frontmatter:

```bash
python3 references/rfe-creator/scripts/frontmatter.py read references/rfe-creator/artifacts/strat-tasks/<filename>.md
```
